...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/res/handlebars/handlebars-v4.0.10.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/static/res/layer/layer.js"></script>
...
<script src="${basePath}/static/common/toast/jquery.toast.min.js"></script>
<script src="${basePath}/static/common/Swiper2/js/idangerous.swiper.min.js"></script>
<%-- <script src="${basePath}/static/js/bundle.min.js"></script> --%>
<script src="${basePath}/static/js/common.js"></script>
<script src="${basePath}/static/dist/js/myCommon.js"></script>
<link rel="shortcut icon" href="${basePath}/static/images/favicon.ico"/>
<link rel="stylesheet" href="${basePath}/static/common/toast/jquery.toast.min.css">
<link rel="stylesheet" type="text/css" media="screen" href="${basePath}/static/common/reset.css" />
<link rel="stylesheet" href="${basePath}/static/common/Swiper2/css/idangerous.swiper.css">
...
<link href="${pageContext.request.contextPath}/static/css/feedback.css">
<link rel="stylesheet" type="text/css" media="screen" href="${basePath}/static/dist/css/common.css" />
